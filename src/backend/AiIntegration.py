...
class Ai():
    ...
    def PerguntarSobrePlaneta(self,planeta,pergunta):
        ...
        por meio de matematica a provabilidade dele ter vida,seu objetivo nesse pronpt é responder a seguinte pergunta 
        do usuario,atente-se! a responder apenas as perguntas relacionadas a exoplaneta,ou o dataset,ou as tecnologias de como
